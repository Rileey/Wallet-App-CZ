...
class _BookingOldWidgetState extends State<BookingOldWidget> {
  ...
  void initState() {
    super.initState();
    personsNameController2 = TextEditingController(text: 'Wallet Name');
  }
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            await GenerateCryptoWalletCopyCall.call(
                              blockchain: dropDownValue,
                              network: 'testnet',
                              walletId: '62ac7ebcd2c7f8000702892d',
                              label: personsNameController2.text,
                            );
                            Navigator.pop(context);
                          },
                          text: 'Create Wallet',
