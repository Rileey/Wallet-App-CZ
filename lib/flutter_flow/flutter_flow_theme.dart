...
class LightModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0xFF2C6FF9);
  Color secondaryColor = const Color(0xFFF2A384);
  Color tertiaryColor = const Color(0xFF003296);
  Color alternate = const Color(0xFFDF3F3F);
  Color primaryBackground = const Color(0xFFF1F4F8);
  Color secondaryBackground = const Color(0xFFFFFFFF);
  Color primaryText = const Color(0xFF090F13);
  Color secondaryText = const Color(0xFF7C8791);
